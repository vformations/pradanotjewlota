...
app.post('/api/pay', async (req, res) => {
  ...
  // Build the relay payload — just the card data the client filled in.
  // Virtual Pay's own page already holds the merchant credentials server-side;
  // we just need to submit the same fields a browser would.
